...
{
    static class BusinessObjectToDataStore
    {
        public static Store.UserInfo Convert(UserInfo o)
        {
        ...
        static Store.Feed Convert(Feed o)
        {
        ...
        static Store.NewsItem Convert(NewsItem o)
        {
        ...
        static Store.Image Convert(Image o)
        {
