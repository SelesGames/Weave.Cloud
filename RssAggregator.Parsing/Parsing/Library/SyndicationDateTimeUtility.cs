...
namespace System
{
    ...
    /// </remarks>
    internal static class SyndicationDateTimeUtility
    {
        //============================================================
        ...
        public static bool TryParseRfc822DateTime(string value, out DateTime result)
        {
            ...
            //------------------------------------------------------------
            var reformatted = SyndicationDateTimeUtility.ReplaceRfc822TimeZoneWithOffset(value);
            //return DateTime.TryParseExact(reformatted, formats, dateTimeFormat, DateTimeStyles.None, out result);
            return DateTime.TryParseExact(reformatted, formats, dateTimeFormat, DateTimeStyles.AdjustToUniversal, out result);
        }
        #endregion
    }
}