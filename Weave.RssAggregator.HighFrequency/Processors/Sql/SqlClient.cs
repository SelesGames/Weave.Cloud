    ...
    public class SqlClient
    {
        ...
        public async Task<bool> InsertNewsItemIfNotExists(EntryWithPostProcessInfo entry)
        {
            ...
            var rows = await storedProcClient.GetAsync<bool>(
                ...
                new SqlParameter("p9", (object)entry.OriginalImageUrl ?? DBNull.Value) { SqlDbType = SqlDbType.NVarChar, IsNullable = true },
                ...
                new SqlParameter("p16", (object)entry.ImageWidth ?? DBNull.Value) { SqlDbType = SqlDbType.Int, IsNullable = true },
                new SqlParameter("p17", (object)entry.ImageHeight ?? DBNull.Value) { SqlDbType = SqlDbType.Int, IsNullable = true },
                new SqlParameter("p18", (object)entry.BaseResizedImageUrl ?? DBNull.Value) { SqlDbType = SqlDbType.VarChar, IsNullable = true },
                new SqlParameter("p19", (object)entry.SupportedFormats ?? DBNull.Value) { SqlDbType = SqlDbType.VarChar, IsNullable = true }
                );
